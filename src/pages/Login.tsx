            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 overflow-y-auto">
                <div className="w-full max-w-md py-8">
                    ...
                    <div className="mb-8 flex justify-between items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 mb-2">{t('login_welcome')}</h2>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                type="button"
                                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
                            >
                        ...
                        <div className="my-6 relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-3 bg-white text-gray-500 font-medium">{t('or_continue_with')}</span>
                            </div>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleLogin}>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link to="/forgot-password" virtual-link-id="forgot-password" className="text-xs font-bold text-blue-600 hover:text-blue-500 hover:underline">
